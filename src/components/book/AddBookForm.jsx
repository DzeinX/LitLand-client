...
export const AddBookForm = ({setMessage}) => {
    ...
    return <div className="add-book-form">
        ...
        <div className="form-container">
            {bookType === 0 && <AddDigitalBook setMessage={setMessage} bookHash={bookHash} setBookTypeVisibility={setBookTypeVisibility} />}
            {bookType === 1 && <AddPhysicalBook setMessage={setMessage} bookHash={bookHash} setBookTypeVisibility={setBookTypeVisibility} />}
        </div>
    </div>
}